package com.github.schiluka.myleetcode.array;
...
public class MergeSortedArray {
    ...
    private static void merge(int[] nums1, int[] nums2, int len1, int len2) {

        int index1 = len1 - 1;
        int index2 = len2 - 1;
        int totalIndex = len1 + len2 - 1;
 ...
 * be merged, and the last n elements are set to 0 and should be ignored. nums2 has a
 * length of n.
 *
 *
 *
